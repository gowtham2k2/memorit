var gamePattern=[];var userPattern=[];var colors=["red","blue","green","yellow"];var gameStarted=!1;var level=0;$(document).on("keydown",()=>{if(!gameStarted){$(".scoreBoard").removeClass("active-touch");setTimeout(()=>{$(".replay").css("display","none");newSequence()},1000);gameStarted=!0}});$(".scoreBoard").on("click",()=>{if(!gameStarted){$(".play").css("display","none");animatePress(".scoreBoard");$("body").fadeOut(100).fadeIn(100).fadeOut(100).fadeIn(100).fadeOut(100).fadeIn(100);$(".scoreBoard").removeClass("active-touch");setTimeout(()=>{$(".replay").css("display","none");newSequence()},1000);gameStarted=!0}});$(".play").on("click",()=>{if(!gameStarted){$(".play").css("display","none");animatePress(".play");$("body").fadeOut(100).fadeIn(100).fadeOut(100).fadeIn(100).fadeOut(100).fadeIn(100);$(".scoreBoard").removeClass("active-touch");setTimeout(()=>{$(".replay").css("display","none");newSequence()},1000);gameStarted=!0}});$(".replay").on("click",()=>{console.log("replay clicked");if(!gameStarted){$(".replay").fadeOut(100).fadeIn(100).fadeOut(100).fadeIn(100).fadeOut(100).fadeIn(100).fadeOut(100).css({display:"none"});$(".scoreBoard").removeClass("active-touch");setTimeout(()=>{newSequence()},1000);gameStarted=!0}});$(".tile").on("click",(e)=>{if(gameStarted){let userChosenColor=e.target.id;userPattern.push(userChosenColor);playBgm(userChosenColor);animatePress(`.tile-wrapper>#${userChosenColor}`);checkResult(userPattern.length-1)}});function newSequence(){level++;userPattern=[];$(".scoreBoard").text("Level "+level).css({animation:"glow 300ms linear"});let randomChosenColor=colors[Math.floor(Math.random()*colors.length)];setTimeout(()=>{playBgm(randomChosenColor);$(`.tile-wrapper>#${randomChosenColor}`).fadeOut(100).fadeIn(100).fadeOut(100).fadeIn(100)},500);setTimeout(()=>{$(".scoreBoard").css({animation:"none"})},500);console.log(randomChosenColor);gamePattern.push(randomChosenColor)}
